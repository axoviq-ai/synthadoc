...
The essay drew on observations of linus-torvalds and the linux kernel development process as a real-world example of the bazaar model succeeding at scale. Raymond's work helped shift the broader conversation around free software toward the more business-friendly term "open source" and influenced the founding of the Open Source Initiative in 1998. ^[raymond-cathedral-bazaar-1999.txt:35-35]

Together, richard-stallman's gnu-project and Free Software Foundation (with the GPL copyleft license) and Torvalds's Linux kernel — combined through distributions like Debian and Red Hat — produced the first complete free Unix-like operating system, GNU/Linux. ^[raymond-cathedral-bazaar-1999.txt:19-19]

## Linux and the GNU/Linux System

In 1991, linus-torvalds, a student at the university-of-helsinki, posted a message to a Usenet newsgroup announcing that he was writing a free operating system kernel for Intel 386 processors "just as a hobby, won't be big and professional." He released the first version of Linux under a licence that initially prohibited commercial use; he later adopted the gnu-general-public-license-gpl. Combined with the GNU userland tools, Linux provided the first complete free Unix-like operating system. Linux grew to become the dominant kernel in servers, cloud computing infrastructure, Android smartphones, embedded systems, and supercomputers. The distributed development model — thousands of contributors coordinated through public repositories and mailing lists — became a template for large-scale open source projects. ^[raymond-cathedral-bazaar-1999.txt:17-21]

## The Cathedral and the Bazaar

Eric S. Raymond (ESR) presented "The Cathedral and the Bazaar" at the Linux Kongress in 1997, later published as an essay. The paper contrasted two models of software development: the *cathedral* model (small groups working in relative isolation before polished releases) and the *bazaar* model (continuous public releases, many developers with varying commit privileges, rapid iteration based on user feedback). Raymond articulated "Linus's Law": given enough eyeballs, all bugs are shallow. The essay circulated at Netscape Communications, whose browser business was losing ground to Microsoft's Internet Explorer. In 1998 Netscape announced it would release the source code of Netscape Communicator, creating the Mozilla project, which eventually produced Firefox. ^[raymond-cathedral-bazaar-1999.txt:25-31]

## Open Source Initiative and Licensing

The term "open source" was proposed in early 1998 by Christine Peterson and adopted at a strategy session that included Raymond, Bruce Perens, and others — intended as a less ideologically charged alternative to "free software" that would be more palatable to businesses. The same year, Perens and Raymond founded the open-source-initiative (OSI) to steward the definition and certify licences. The OSI definition specifies that compliant licences must permit free redistribution, must include source code, must allow derived works, and must not discriminate against persons, groups, or fields of endeavour. A spectrum of licences emerged: the GPL and its variants (LGPL, AGPL) impose copyleft requirements; the MIT and BSD licences are permissive; the Apache licence adds patent grant provisions. ^[raymond-cathedral-bazaar-1999.txt:35-37]

## Impact on Internet Infrastructure

By the early 2000s, open source software underpinned most internet infrastructure: Linux and BSD servers, the Apache web server, the Sendmail and Postfix mail transfer agents, the BIND DNS server, and MySQL and PostgreSQL databases. The LAMP stack (Linux, Apache, MySQL, PHP) became the standard platform for web applications. GitHub, launched in 2008, lowered the barrier to participation by providing a web interface for Git-based version control, making it easy for any developer to fork a project, propose changes, and have them reviewed. Open source became the default model for new infrastructure software. ^[raymond-cathedral-bazaar-1999.txt:41-43]

## The Cathedral and the Bazaar (1997)

Eric S. Raymond presented a paper titled "The Cathedral and the Bazaar" at the Linux Kongress in 1997, later expanded into a widely read essay. It contrasted two models of software development: the **cathedral model**, in which small groups of developers worked in isolation and released polished versions infrequently, and the **bazaar model**, exemplified by [[linux]] development, in which source code was released continuously, many developers had commit access, and rapid iteration was driven by user feedback. ^[raymond-cathedral-bazaar-1999.txt:25-27]

Raymond articulated "Linus's Law": *given enough eyeballs, all bugs are shallow*. The argument held that a sufficiently large community of co-developers would identify and resolve defects faster than any closed team, because a given bug would be novel to fewer contributors. ^[raymond-cathedral-bazaar-1999.txt:29-29]

The essay had immediate practical consequences. It circulated at Netscape Communications, whose browser was losing market share to Microsoft's Internet Explorer. In January 1998, Netscape announced it would release the source code of Netscape Communicator, spawning the Mozilla project, which eventually produced the Firefox browser. ^[raymond-cathedral-bazaar-1999.txt:31-31]

## Open Source Initiative and Licensing

In early 1998, Christine Peterson proposed the term "open source" as a less ideologically charged alternative to "free software" that would be more palatable to businesses. The term was adopted at a strategy session attended by [[eric-s-raymond]], Bruce Perens, and others. That same year, Perens and Raymond founded the [[open-source-initiative]] (OSI) to maintain the formal Open Source Definition and certify compliant licences. ^[raymond-cathedral-bazaar-1999.txt:35-35]

The OSI definition requires that conformant licences permit free redistribution, include source code, allow derived works, and not discriminate against persons, groups, or fields of endeavour. Under this framework a spectrum of licences emerged: the [[gnu-general-public-license]] family (GPL, LGPL, AGPL) imposes copyleft; the MIT and BSD licences are permissive; the Apache Licence 2.0 adds explicit patent grants. ^[raymond-cathedral-bazaar-1999.txt:37-37]

## LAMP Stack and Infrastructure Adoption

By the early 2000s, open source software underpinned most internet infrastructure. Linux and BSD ran the majority of servers; the Apache HTTP Server dominated web serving; Sendmail and Postfix handled mail transfer; BIND provided DNS; and MySQL and PostgreSQL served as databases. The **LAMP stack** — Linux, Apache, MySQL, and PHP/Python/Perl — became the standard platform for web applications throughout the 2000s. ^[raymond-cathedral-bazaar-1999.txt:41-41]

## GitHub and Modern Collaboration

GitHub, launched in 2008, provided a web-based interface for Git version control that lowered the barrier to participation in open source projects. Developers could fork a repository, propose changes via pull requests, and have those changes reviewed by maintainers — all through a browser. This tooling helped make open source collaboration the default model for new infrastructure and application software. ^[raymond-cathedral-bazaar-1999.txt:43-43]