...
- **Efficiency**: Packet switching enabled multiple users to share network bandwidth simultaneously, rather than dedicating a entire circuit for a single communication.^[leiner-brief-history-internet-2009.txt:9-9]
...
ARPANET's first message was transmitted on 29 October 1969, between a computer at ucla and one at the Stanford Research Institute. The intended message was "login," but the system crashed after the first two letters, transmitting only "lo." By December 1969, four nodes were connected: UCLA, the Stanford Research Institute, the University of California Santa Barbara, and the University of Utah.^[leiner-brief-history-internet-2009.txt:11-11]

## Electronic Mail (1971)

Network email predated the World Wide Web by two decades. The first ARPANET email was sent by Ray Tomlinson in 1971. Tomlinson also introduced the use of the @ symbol to separate the user name from the host name — a convention that persists unchanged. Email rapidly became the dominant use of ARPANET, consuming a larger share of network traffic than any other application by the mid-1970s.^[leiner-brief-history-internet-2009.txt:29-29]

## Domain Name System (1983)

As the network grew, the original mechanism for mapping host names to numeric addresses — a single text file called HOSTS.TXT maintained by the Stanford Research Institute and distributed periodically to all nodes — became unworkable. By 1983 the file required constant updates and its distribution created bottlenecks.^[leiner-brief-history-internet-2009.txt:23-23]

Paul Mockapetris designed the Domain Name System (DNS) in 1983. DNS replaced the centralised file with a distributed, hierarchical database. Responsibility for portions of the namespace was delegated to authoritative servers at each domain, which could be updated independently. DNS made the network scalable to millions and eventually billions of hosts.^[leiner-brief-history-internet-2009.txt:25-25]

## BSD Unix and TCP/IP Propagation

The 1983 Berkeley [[unix-history|BSD Unix]] distribution included a high-quality, publicly available TCP/IP implementation that was adopted by universities, research institutions, and eventually commercial vendors, playing a major role in propagating TCP/IP beyond ARPANET.^[leiner-brief-history-internet-2009.txt:19-19]

## The World Wide Web

Tim Berners-Lee, a physicist at cern in Geneva, proposed the World Wide Web in a 1989 document titled "Information Management: A Proposal." He implemented it in 1990 and released the software publicly in 1991.^[leiner-brief-history-internet-2009.txt:33-33]

The Web introduced three interrelated technologies: HTML (HyperText Markup Language) for encoding documents, HTTP (HyperText Transfer Protocol) for requesting and serving them, and URLs (Uniform Resource Locators) for addressing them. Hyperlinks in HTML documents allowed readers to navigate from one document to another on any server, creating a global web of connected information usable without technical knowledge.^[leiner-brief-history-internet-2009.txt:35-35]

The first graphical web browser, Mosaic, was released by the National Center for Supercomputing Applications in 1993. Mosaic made the Web accessible to a general audience by displaying images inline with text. Netscape Navigator, released in 1994, brought the Web to millions of homes.^[leiner-brief-history-internet-2009.txt:37-37]

## Commercialisation and NSFNET (1995)

The National Science Foundation Network (NSFNET), which had provided the internet's backbone in the United States through the late 1980s, was retired in 1995 as commercial internet service providers assumed responsibility for the backbone infrastructure — marking the formal commercialisation of the internet.^[leiner-brief-history-internet-2009.txt:41-41]

Growth through the 1990s was exponential: the number of websites grew from a few hundred in 1992 to over a million by 1997. By 2000, internet access was widespread in North America, Western Europe, and parts of Asia, though global connectivity remained uneven.^[leiner-brief-history-internet-2009.txt:43-43]
