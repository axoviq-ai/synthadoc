        ...
        *,
        ...
        if system_ctx:
            return (
                ...
                f"When showing CLI commands, always wrap them inside triple-backtick code fences "
                f"(```bash ... ```) exactly as they appear in the documentation — never output them as plain text. "
                f"Angle-bracket placeholders such as <schedule-id> or <slug> are literal CLI arguments — "
                f"reproduce them verbatim inside the code fence, do not omit or paraphrase them. "
