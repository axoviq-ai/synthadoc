...
- **Reagent identity** — chemical name, CAS number, catalog number, supplier, grade (analytical / HPLC / biological / technical)
- **Storage** — storage condition (room temperature / 4°C / -20°C / -80°C / N2 atmosphere), storage location (building, room, freezer/fridge ID)
- **Inventory** — current stock quantity, units, lot numbers in stock, reorder point, reorder quantity
