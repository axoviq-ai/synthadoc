...
```
synthadoc ingest "https://subjectguides.lib.neu.edu/Protocolsio" -w <wiki>
```
...
synthadoc ingest "https://datamanagement.hms.harvard.edu/collect-analyze/electronic-lab-notebooks" -w <wiki>
```
