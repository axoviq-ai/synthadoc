...
```
synthadoc ingest "https://developer.hashicorp.com/terraform/language/modules" -w <wiki>
synthadoc ingest "https://developer.hashicorp.com/terraform/language/modules/develop" -w <wiki>
synthadoc ingest "https://sre.google/sre-book/postmortem-culture/" -w <wiki>
synthadoc ingest "https://runframe.io/blog/post-incident-review-template" -w <wiki>
synthadoc ingest "https://www.atlassian.com/incident-management/postmortem" -w <wiki>
