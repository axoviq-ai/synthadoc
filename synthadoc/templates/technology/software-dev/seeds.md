...
```
synthadoc ingest "https://martinfowler.com/architecture" -w <wiki>
synthadoc ingest "https://sre.google/books" -w <wiki>
synthadoc ingest "https://research.google/pubs/the-site-reliability-workbook" -w <wiki>
synthadoc ingest "https://svitla.com/blog/open-api-specification-industry-standard-swagger" -w <wiki>
