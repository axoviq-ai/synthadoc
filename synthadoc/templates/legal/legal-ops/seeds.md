...
```
synthadoc ingest "https://www.cloc.org/resources/" -w <wiki>
```

**ACC — Association of Corporate Counsel legal resources and publications (free)**
```
synthadoc ingest "https://www.acc.com/legalresources/" -w <wiki>
```
...
```
synthadoc ingest "https://cloc.org/resources/state-of-the-industry/" -w <wiki>
synthadoc ingest "https://www.acc.com/legalresources/publications/topten/how-to-best-use-your-outside-counsel.cfm" -w <wiki>
synthadoc ingest "https://www.acc.com/legalresources/publications/topten/top-ten-tips-for-managing-legal-spend.cfm" -w <wiki>
synthadoc ingest "https://www.contractlogix.com/blog/contract-management-best-practices/" -w <wiki>
