...
```
synthadoc ingest "https://agorareal.com/learn/commercial-lease-abstract-template" -w <wiki>
...
synthadoc ingest "https://www.checkproof.com/blog/work-order-software/best-practices-for-work-order-management" -w <wiki>
synthadoc ingest "https://www.wexfordins.com/post/property-management-vendor-requirements-coi-package" -w <wiki>
```
