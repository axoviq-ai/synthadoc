...
```
synthadoc ingest "https://bcpa.net/ZoningDefinitions.htm" -w <wiki>
```
...
```
synthadoc ingest "https://aecify.com/resources/rfi-log-template" -w <wiki>
synthadoc ingest "https://archdesk.com/blog/rfi-log-template-construction" -w <wiki>
...
synthadoc ingest "https://www.procore.com/library/aia-g702-application-for-payment" -w <wiki>
synthadoc ingest "https://communityinvestment.lacity.gov/sites/g/files/wph2001/files/2024-10/G702%20-%20%20Application%20For%20Payment_Remediated.pdf" -w <wiki>
