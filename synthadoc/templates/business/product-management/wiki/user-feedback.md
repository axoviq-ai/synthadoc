...
- **Feedback identity** — source (support ticket / NPS / user interview / sales call / Slack community / app store review), customer segment, date
- **Feedback theme** — categorized topic (onboarding / performance / missing feature / bug / pricing / UX / documentation)
- **Verbatim** — the actual customer words (exact quote where available)
- **Sentiment** — positive / neutral / negative; emotional intensity
