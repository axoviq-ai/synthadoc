...
- **Keyword portfolio** — target keywords organized by cluster/pillar, monthly search volume, keyword difficulty, current ranking position, target position, owned URL
- **Keyword priority tiers** — Tier 1 (highest volume, strategic), Tier 2 (niche but converting), Tier 3 (long-tail, quick wins)
- **On-page optimization** — title tag and meta description standards, header hierarchy (H1–H3) rules, target keyword density guidelines, internal linking strategy
