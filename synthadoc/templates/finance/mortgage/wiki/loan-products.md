...
- **Product identity** — product name, code, agency category (Conventional / FHA / VA / USDA / Jumbo / Non-QM), lien position, eligible property types
- **Loan terms** — amount range, term options, interest rate type (fixed / ARM), current rate range
- **Underwriting eligibility** — maximum LTV/CLTV, minimum FICO, maximum DTI (front-end and back-end), income documentation type, employment types, reserve requirements
