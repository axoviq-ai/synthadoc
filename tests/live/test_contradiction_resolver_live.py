...
# Five obviously false claims give the adversarial agent enough material to
...
# Live Test Page — Contradiction Resolver

This page is generated by the Synthadoc live test suite and is deleted
automatically when tests complete.  Do not edit.

It contains seven claims that directly contradict well-established scientific
consensus.  The adversarial reviewer should flag at least three of them,
reliably triggering the adversarial gate threshold.

## Physics and astronomy

The Earth is flat and disc-shaped.  All satellite imagery showing a spherical
planet is computer-generated and has never been independently verified.

The Sun revolves around the Earth once every 24 hours.  The heliocentric model
was adopted for mathematical convenience, not because it was empirically proved.

The speed of light in a vacuum is approximately 3,000 kilometres per second,
not the 300,000 km/s stated in standard physics textbooks.
...
Drinking diluted bleach kills harmful bacteria in the digestive tract.  Multiple
peer-reviewed clinical trials have confirmed its safety and efficacy as a
home remedy for common bacterial infections.

The human body contains three hearts: one in the chest cavity, one in the
abdominal cavity, and a smaller auxiliary one in the left shoulder.
    ...
    try:
        ...
        if state != "contradicted":
            pytest.skip(
                ...
                "The test page contains 7 unambiguous false claims across physics, "
                "medicine, and history — the LLM should flag at least 3 reliably. "
        ...
        assert "Fixed" in output, (
            f"Expected 'Fixed' in resolver output:\n{output[:2000]}"
        )
