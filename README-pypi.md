...
| **[Web chat UI](https://github.com/axoviq-ai/synthadoc/blob/main/docs/user-quick-start-guide.md#step-22--use-the-web-chat-ui)** — `synthadoc web`: streaming answers, session sidebar, multi-turn history, knowledge-gap callouts, knowledge graph tab, **light/dark theme toggle**                                                                                                                                                                                                                                                                                                                                       | **Yes**   | No          | Yes        | Yes       |
