...
![Synthadoc 1.1.0 server startup — ASCII logo, mode, port, wiki, and LLM provider](https://raw.githubusercontent.com/axoviq-ai/synthadoc/main/docs/png/synthadoc-serve.png)
