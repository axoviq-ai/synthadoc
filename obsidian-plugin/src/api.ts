...
export const api = {
    ...
    auditHistory:  (limit = 50, offset = 0)   => call(`/audit/history?limit=${limit}&offset=${offset}`),
    auditCosts:    (days = 30)                => call(`/audit/costs?days=${days}`),
    queryHistory:  (limit = 50, offset = 0)   => call(`/audit/queries?limit=${limit}&offset=${offset}`),
    auditEvents:   (limit = 100, offset = 0)  => call(`/audit/events?limit=${limit}&offset=${offset}`),
